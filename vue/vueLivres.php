<div class="menuchercher">
    <form class="formorder" method="GET">
        ...
        <button type="submit" name="sort" value="cotation_asc">Trier par Cotation (1-9)</button>
        <button type="submit" name="sort" value="cotation_desc">Trier par Cotation (9-1)</button>
</div>
<div class="livres-container">
    ...
    foreach ($ToutLivres as $livre) {
        ...
        echo "<p><strong>Cotation : </strong>" . htmlspecialchars($livre["cotation"]) . "</p>";
